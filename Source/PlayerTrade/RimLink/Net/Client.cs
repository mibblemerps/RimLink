...
namespace RimLink.Net
{
    public class Client : Connection
    {
        ...
        public string Guid => RimLink.Guid; // Unique user ID
        ...
        public IEnumerable<Player> GetPlayers(bool online = false, bool includeSelf = false)
        {
            ...
            {
                // Get offline players
                foreach (Player player in RimLink.RememberedPlayers.Where(p => !p.IsOnline))
                {
        ...
        private void OnPacketReceived(object sender, PacketReceivedEventArgs e)
        {
            ...
            try
            {
                switch (e.Packet)
                {
                    ...
                    {
                        RimLink.Instance.IsAdmin = adminPacket.IsAdmin;
                        break;
                    }
                    ...
                    {
                        AnnouncementUtil.Show(announcementPacket);
                        break;
                    }
